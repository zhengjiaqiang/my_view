...
xml version="1.0" encoding="UTF-8"?>
		...
		<link rel="stylesheet" href="styles/shouwei/login.css?" type="text/css" />
		<div id="main">
		<form method="post" action="<?php echo U('Login/regist');?>">
		<div class="mb15">
		<label>
		<span class="font14 c96">用户名：</span>
		</label>
		<input id="user_name" name="uname" type="text" class="font14"/>
		</div>
		<div>
		<label>
		<span class="font14 c96">密&nbsp;码：</span>
		</label>
		<input id="password" name="upwd" type="password" checked="checked" class="font14"/>
		</div>
		<p><input type="submit" value="立即注册" class="login_btn"/></p>
		</form>
		</div>
		<!--尾部-->
		<div id="foot">
